...
public class WalletServiceImplTest {
	...
	{
		Customer customer1 = new Customer("9949453482","Varun","Varun@123","pulivarun125@gmail.com",new Wallet(),new TreeMap<LocalDateTime, String>());
    ...
    @Test
  	public void addCustomerTestFalse() throws BankException
  	{
  		...
  		Customer customer2 = new Customer("8885599776","Vineeth","Vineeth@123","balusanivineeth8@gmail.com",new Wallet(),new TreeMap<LocalDateTime, String>());
	...
	{
		Customer customer2 = new Customer("8885599773","Vineeth","Vineeth@123","balusanivineeth8@gmail.com",new Wallet(),new TreeMap<LocalDateTime, String>());
		iWalletService.addCustomer(customer2);
		iWalletService.deposit(customer2, BigDecimal.valueOf(8500.00));
		Customer result = iWalletService.showBalance("8885599773", "Vineeth@123");
